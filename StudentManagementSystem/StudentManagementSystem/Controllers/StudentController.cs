...
namespace StudentManagementSystem.Controllers
{
    ...
    {
        private string _connectionString = @"Data Source=DESKTOP-PQ6SVM3\SQLEXPRESS;Initial Catalog=School;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        ...
        {
            string querryString = "Select * From Students where id = @id";
            Student student = new Student();
